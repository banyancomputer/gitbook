...
* [API reference](api-reference/README.md)
  * [Buckets](api-reference/buckets/README.md)
    * [Metadata](api-reference/buckets/metadata/README.md)
      * [Current](api-reference/buckets/metadata/current.md)
      * [Pull](api-reference/buckets/metadata/pull.md)
      * [Snapshot](api-reference/buckets/metadata/snapshot.md)
    * [Keys](api-reference/buckets/keys.md)
    * [Snapshots](api-reference/buckets/snapshots/README.md)
      * [Restore](api-reference/buckets/snapshots/restore.md)
    * [Usage](api-reference/buckets/usage.md)
    * [Authorization grants](api-reference/buckets/authorization-grants.md)
  ...
  * [Subscriptions](api-reference/subscriptions/README.md)
    * [Subscribe](api-reference/subscriptions/subscribe.md)
    * [Manage](api-reference/subscriptions/manage.md)
    * [Success](api-reference/subscriptions/success.md)
    * [Cancel](api-reference/subscriptions/cancel.md)
  * [Auth](api-reference/auth/README.md)
    * [Device api key](api-reference/auth/device-api-key.md)
    * [Who am i](api-reference/auth/who-am-i.md)
  * [Blocks](api-reference/blocks/README.md)
    * [Locate](api-reference/blocks/locate.md)
  * [Users](api-reference/users/README.md)
    * [Escrowed device](api-reference/users/escrowed-device.md)
    * [Current](api-reference/users/current.md)
* [Specification](https://firebasestorage.googleapis.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FGMA1R9unbzLhKZzpfelc%2Fimports%2FuGBsyPSGW78aSnZi7wZo%2Fcore-service-client-spec.json?alt=media\&token=8a80ce34-7d4e-40ed-a5a9-621f2c60b4e8)
